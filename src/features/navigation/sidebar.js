...
export function renderSidebar() {
  ...
  container.innerHTML = /* html */`
    ...
    <div class="flex-1 px-4 space-y-2">
      ...
      <a href="#" class="flex items-center gap-3 bg-lummia-sage/10 text-lummia-sage p-3 rounded-xl border border-lummia-sage/20 shadow-[0_0_15px_rgba(88,166,115,0.05)] group">
      ...
      <a href="#" class="flex items-center gap-3 p-3 text-gray-400 hover:text-white hover:bg-white/5 rounded-xl transition group">
    ...
    <div class="p-4 mt-auto">
      <div class="p-4 bg-white/5 rounded-2xl border border-white/5 text-center relative overflow-hidden group cursor-pointer hover:border-lummia-sage/30 transition-colors">
        <div class="absolute inset-0 bg-lummia-sage/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
        
        <img src="/assets/shield.png" alt="Clan Shield" class="text-gray-300 w-10 h-10 mx-auto mb-2 object-contain group-hover:scale-110 transition-transform">
